...
export default class Floor {
    ...
    setCircles() {
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0xedd69e });
        const material2 = new THREE.MeshStandardMaterial({ color: 0xedd69e });
        const material3 = new THREE.MeshStandardMaterial({ color: 0xedd69e });
